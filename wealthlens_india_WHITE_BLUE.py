...
if not st.session_state.free_user_registered:
    st.markdown("""
    <div style="background:linear-gradient(135deg,#1a56db,#1e40af);border:2px solid #93c5fd;
                border-radius:20px;padding:2.5rem;text-align:center;margin-bottom:2rem">
        <div style="font-size:3rem">📊</div>
        <h2 style="color:#ffffff;font-family:'Playfair Display',serif;margin:0.5rem 0">
